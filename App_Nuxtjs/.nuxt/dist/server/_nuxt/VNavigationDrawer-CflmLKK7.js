import { V as VDialogTransition, c as makeDelayProps, u as useScopeId, d as useDelay } from "./VOverlay-Bq6vi5Fa.js";
import { m as makeComponentProps, b as makeTagProps, w as makeBorderProps, f as makeDensityProps, g as makeElevationProps, j as makeRoundedProps, x as makeSizeProps, k as makeVariantProps, E as useResizeObserver, c as useRender, d as VBtn, R as Ripple, V as VIcon, n as useDensity, s as useTextColor, v as useBackgroundColor, e as VDefaultsProvider, a as makeDimensionProps, B as makeRouterProps, D as useLink, y as useBorder, l as useVariant, u as useDimension, o as useElevation, r as useRounded, t as genOverlays, F as useRouter, G as toPhysical } from "./VBtn-BQh1DFk2.js";
import { f as breakpoints, p as propsFactory, g as genericComponent, I as IconValue, s as makeThemeProps, h as useProxiedModel, v as useLocale, e as useRtl, t as provideTheme, z as useDisplay, y as provideDefaults, A as createRange, B as keyValues, C as deepEqual, j as getUid, D as filterInputAttrs, E as wrapInArray, F as matchesSelector, o as omit, w as getCurrentInstance, G as consoleError, H as defineComponent, J as EventProp, K as deprecate, L as getPropertyFromItem, q as focusChild, M as clamp, N as debounce, O as useToggleScope, x as convertToUnit, P as ensureValidVNode, Q as checkPrintable, R as makeDisplayProps } from "../server.mjs";
import { capitalize, computed, h, ref, shallowRef, toRef, createVNode, mergeProps, nextTick, provide, onScopeDispose, withDirectives, Fragment, resolveDirective, inject, toRaw, vShow, watch, watchEffect, createTextVNode, Transition } from "vue";
import { m as makeVTextFieldProps, V as VTextField } from "./VTextField-DYVwMBTO.js";
import { V as VLabel, a as VExpandTransition, u as useForm } from "./VInput--HWDDWXB.js";
import { M as MaybeTransition, m as makeTransitionProps, f as forwardRefs } from "./forwardRefs-B2cVIy3B.js";
import { a as VMenu } from "./HeaderComponent-B3CWU5QU.js";
...
import { m as makeLayoutProps, c as createLayout, a as makeLayoutItemProps, u as useLayoutItem } from "./VMain-B0aKjWRH.js";
...
export {
  ...
  VListItemTitle as f,
  VList as g,
  VVirtualScrollItem as h,
  VCheckboxBtn as i,
  makeVirtualProps as m,
  useVirtual as u
};
//# sourceMappingURL=VNavigationDrawer-CflmLKK7.js.map
