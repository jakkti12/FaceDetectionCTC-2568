...
export { getUser, getUserTeacher, getWeeks, getCheckLine, getCheckLineWeekDay, getCheckLineById, getCheckLineByIds, updatedCheckLine, getDayByweekId, percentageIineup, percentageIineupTeacher } from '../utils/users';
